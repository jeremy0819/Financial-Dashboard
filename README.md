...
>
> **v4.0 新增：即時數據訊號（均線排列／P-E 一年百分位／營收動能／毛利趨勢）、全站資料新鮮度標示、台股紅漲綠跌、手機 RWD（抽屜式側欄）**
...
```
Layer 1 — 財務健檢    即時數據訊號（均線排列/估值百分位/營收動能/毛利趨勢）+ 技術均線圖 + 月營收圖
...
| 引擎 | 來源 | 說明 |
|---|---|---|
| **真實數字** | FinMind API（日收盤，非盤中即時；台股當日、美股約延遲 1 交易日） | 股價/漲跌、P/E、P/B、殖利率、P/E 一年百分位、月營收年增、財報利潤率、EPS（台股完整；美股提供股價與均線） |
